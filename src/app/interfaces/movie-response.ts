...
export class Convert {
    public static toMovieResponse(json: string): MovieResponse {
        return cast(JSON.parse(json), r("MovieResponse"));
    }

    public static movieResponseToJson(value: MovieResponse): string {
        return JSON.stringify(uncast(value, r("MovieResponse")), null, 2);
    }
}
